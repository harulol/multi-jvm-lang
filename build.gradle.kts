...
dependencies {
    shade("org.jetbrains.kotlin:kotlin-stdlib:1.7.20-RC")
    shade("org.jetbrains.kotlin:kotlin-reflect:1.7.20-RC")
    shade("org.jetbrains.kotlinx:kotlinx-coroutines-core:1.6.4")
    shade("org.jetbrains.kotlinx:kotlinx-serialization-core:1.4.0")
    shade("org.apache.groovy:groovy-all:4.0.5")
    shade("org.scala-lang:scala3-library_3:3.2.1-RC2")
